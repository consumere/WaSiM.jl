...
# end # module
# #source functions
# #include("C:/Users/Public/Documents/Python_Scripts/julia/func-win.jl")
...
#    using PlotlyJS
    ...
    function rp(x::Raster)
        contourf(x; c=cgrad(:matter),
        #size=(1200, 800),
        xlabel="",ylabel="",title=name(x))
    end
...
#cd("D:/Wasim/Tanalys/DEM/brend_fab/out/")
#cd("D:/temp/saale/out_smf200/")

...
module cmk
    ...
    export cloudplot, cloudplot2, mkecont, mkecont2, mkemon, mkestream, 
    mkpoly, mkrheat, tsbar, tsdf, tsp, tsp2, tsp3, tspblack
    #tovec, 
    ...
    function plot_raster_and_points(raster, points)    
        ...
        Mke.heatmap!(axs,raster)
        for pt in ptc_tuples
            Mke.scatter!(axs,points, markersize = 5, color = :red)
        end
    ...
    function mkestream(r::Raster;wasim=true,missval=0)
        ...
        # Create a function that returns the velocity at a given point

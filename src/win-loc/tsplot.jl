...
##try to use precompilation
#https://medium.com/coffee-in-a-klein-bottle/speeding-up-julia-precompilation-97f39d151a9f

# using Pkg
# Pkg.add("PackageCompiler")
# #using PackageCompiler, IJulia, Flux, Plots
# #julia --startup-file=no #1.8.5
# using PackageCompiler, PlotlyJS, DataFrames, CSV, Dates
# pt,nm=("/home/ubu/.julia/JuliaImages","sys_js_ts_plots.so")
# joinpath(pt,nm)
# create_sysimage([:PlotlyJS,:DataFrames,:CSV,:Dates],sysimage_path=joinpath(pt,nm))

#[04m:28s] PackageCompiler: compiling incremental system image
#297.315  MB 2023-04-04 15:05    .      

#julia --startup-file=no --sysimage "/home/ubu/.julia/JuliaImages/sys_js_ts_plots.so" /mnt/c/Users/Public/Documents/Python_Scripts/julia/tsplot.jl


# Putting everything together…
# If things got confused with the mix of code and text, here are the complete commands 
# you need to run in your Julia session to get everything working.

# using Pkg
# Pkg.add("PackageCompiler")
# using PackageCompiler, IJulia, Flux, Plots
# create_sysimage([:Flux,:Plots],sysimage_path="/home/username/JuliaImages/sys_flux_plots.so")
